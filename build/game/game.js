...
class Game {
    constructor() {
        ...
        this.moveBulletBackground = (velocity) => {
            this.bossBulletArr.forEach((eachBullet) => {
                eachBullet.originX += velocity;
            });
        };
        this.moveHadoukenBackground = (velocity) => {
            this.hadoukenArr.forEach((eachHadouken) => {
                eachHadouken.hadouken.x += velocity;
            });
        };
        //Background (Plataforms and ground)
        this.mapping = (movingElementPositionX, movingElementPositionY) => {
            const platform = mapPrint.filter((eachPlatfom) => {
        ...
        this.colisionSonicKen = () => {
            this.sonicArr.forEach((eachSonic) => {
                ...
                if (eachSonic.positionX < this.player.positionX + this.player.action.w &&
        ...
        this.colisionSonicHadouken = () => {
            this.hadoukenArr.forEach((eachHadouken) => {
                this.sonicArr.forEach((eachSonic) => {
                    if (eachSonic.positionX < eachHadouken.hadouken.x + eachHadouken.hadouken.w &&
        ...
        this.colisionBossBulletKen = () => {
            this.bossBulletArr.forEach((eachBossBullet) => {
                ...
                if (eachBossBullet.originX < this.player.positionX + this.player.action.w &&
        ...
        this.colisionBossHadouken = () => {
            ...
            this.hadoukenArr.forEach((eachHadouken) => {
                if (this.boss.positionX < eachHadouken.hadouken.x + eachHadouken.hadouken.w &&
